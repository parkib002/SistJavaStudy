...
const ShopUpdate = () => {
    ...
    let detailUrl = `http://localhost:9000/shop/detail?num=${num1}`;
    let updateUrl = "http://localhost:9000/shop/update";
    ...
    const onUpdate = () => {
        ...
        axios.post(updateUrl, { sangpum, su, dan })  //{"sangpum":sangpum} 같을땐 생략 (key값이 스프링 이름과 일치)
            .then(() => {
                //insert성공후 처리할 코드
                navi("/shop/list");
            })
