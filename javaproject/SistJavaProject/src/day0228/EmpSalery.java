...
class Emp{
	...
	//가족수당..가족한명당 5만원(단 4인 이상은 무조건 20만원으로 통일)
...
///////////////////////////////////////
///메인에서는 인원을 입력 후 해당 사원에 대한 이름,기본급,가족수,오버타임을 입력 받아 출력할 것!!!
public class EmpSalery {
	...
	public static void showEmpSalery(Emp[] emp)
	{
		...
		Emp.showTitle();
		for(Emp e:emp)
			System.out.println(e.getName()+"\t"+e.getPay()+"\t"+e.getFamSu()+"\t"+e.getTimeSu()+"\t"+e.getFamSudang()+
