...
<form action="update" method="post">
		...
		<table class="table table-bordered" style="width: 500px;">
			<caption align="top"><b>음식 정보 수정</b></caption>
			<tr>
				<th>음식명</th>
				<td>
					<input type="text" name="foodname" class="form-control"
					style="width: 100px;" required="required" value="${dto.foodname }">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					style="width: 100px;" required="required" value="${dto.foodprice }">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					style="width: 100px;" value="${dto.ipgoday }">
				</td>
			</tr>
			<tr>
